...
var mdFactory = () => {
  return {
    ...
    descriptions: [
      ...
      'Our services range from a basic wash to a full detail for anything with a motor--even boats and planes. This includes waxing, carpet/upholstery shampooing and conditioning, headlight buffing and tire shining. The best part is that we are completely mobile, which means no interruptions in your schedule. We\'ll happily come to you wherever you are.',
      'For more information, check out our services and pricing, and be sure to visit our photo gallery for some before and afters. If you would like to schedule an appointment or have any questions or comments, please fill out our form or call or text 941.888.3533. We look forward to hearing from you!',
      'TPS'
    ]
  };
};
